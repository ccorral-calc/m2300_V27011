...
#define BASE_ADDRESS 0x80600000
...
struct ohci_more_immed_t {
    ...
    volatile word_t	desc_cmd_word;	// = 0x0200;
...
struct ohci_last_t {
  volatile word_t       desc_reqCount;   // = 16
  volatile word_t       desc_cmd_word;   // = 0x100C
...
struct ohci_input_more_t {
  ...
  volatile word_t	desc_cmd_word;	// = 0x280C
  ...
  volatile word_t	resCount;		// = number of unused buffer bytes
