...
#define CS6651_BASE            0x81000000  //Temp
...
/*Register 0x18*/
#define CS6651_DISPLAY_MODE             0x204
#define CS6651_EXIT_HOST_DISPLAY        0x200
...
typedef enum {
  ...
  CS6651_ENTER_PAUSE                    = CS6651_FUNC(10),
